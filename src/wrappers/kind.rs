...
impl Kind {
    pub(super) fn c_int(self) -> libc::c_int {
        ...
        match self {
            ...
            Kind::BFloat16 => 15,
            Kind::Float8_e5m2 => 23,
            Kind::Float8_e4m3fn => 24,
            Kind::Float8_e5m2fnuz => 25,
            Kind::Float8_e4m3fnuz => 26,
        }
    }
    ...
    pub(super) fn from_c_int(v: libc::c_int) -> Result<Kind, crate::TchError> {
        match v {
            ...
            14 => Ok(Kind::QInt32),
            15 => Ok(Kind::BFloat16),
            23 => Ok(Kind::Float8_e5m2),
            24 => Ok(Kind::Float8_e4m3fn),
            25 => Ok(Kind::Float8_e5m2fnuz),
            26 => Ok(Kind::Float8_e4m3fnuz),
    ...
    pub fn elt_size_in_bytes(self) -> usize {
        match self {
            ...
            Kind::BFloat16 => 2,
            Kind::Float8_e5m2 => 1,
            Kind::Float8_e4m3fn => 1,
            Kind::Float8_e5m2fnuz => 1,
            Kind::Float8_e4m3fnuz => 1,
        }
    }
}
